...
export function MonthTargetScreen({ month, notify, onBack, onChanged, cacheScope }: PanelProps & { month: string }) {
...
export function RecurringScreen({ notify, onBack, onChanged, cacheScope }: PanelProps) {
